...
# Models with per-model customized settings
models_customized = [
    {
        ...
        "default_params": {
            "temperature": 0.7, "top_p": 0.9, "gpu_layers": 32, "max_tokens": 2048,
            "cpu_thread_pool_size": 6, "evaluation_batch_size": 1024,
            "rope_freq_base": 10000, "rope_freq_scale": 1.0,
            "offload_kv_cache_to_gpu": True, "keep_model_in_memory": True, "try_mmap": True,
            "seed": "auto", "flash_attention": True,
            "k_cache_quantization_type": "auto", "v_cache_quantization_type": "auto"
        }
    },
    {
        ...
        "default_params": {
            "temperature": 0.7, "top_p": 0.9, "gpu_layers": 32, "max_tokens": 2048,
            "cpu_thread_pool_size": 6, "evaluation_batch_size": 256,
            "rope_freq_base": 10000, "rope_freq_scale": 1.0,
            "offload_kv_cache_to_gpu": True, "keep_model_in_memory": True, "try_mmap": True,
            "seed": "auto", "flash_attention": True,
            "k_cache_quantization_type": "q4", "v_cache_quantization_type": "fp16"
        }
    },
    {
        ...
        "default_params": {
            "temperature": 0.7, "top_p": 0.9, "gpu_layers": 32, "max_tokens": 2048,
            "cpu_thread_pool_size": 6, "evaluation_batch_size": 512,
            "rope_freq_base": 10000, "rope_freq_scale": 1.0,
            "offload_kv_cache_to_gpu": True, "keep_model_in_memory": True, "try_mmap": True,
            "seed": "auto", "flash_attention": True,
            "k_cache_quantization_type": "fp16", "v_cache_quantization_type": "fp16"
        }
    },
    {
        "name": "Unsloth",
    ...
    },
    {
        ...
        "default_params": {
            "temperature": 0.0, "top_p": 1.0, "gpu_layers": 0, "max_tokens": 512,
            "cpu_thread_pool_size": 6, "evaluation_batch_size": 2048,
            "rope_freq_base": 10000, "rope_freq_scale": 1.0,
            "offload_kv_cache_to_gpu": False, "keep_model_in_memory": True, "try_mmap": True,
            "seed": "auto", "flash_attention": False,
            "k_cache_quantization_type": "q4", "v_cache_quantization_type": "q4"
        }
    },
    {
    ...
    },
    {
        ...
        "default_params": {
            "temperature": 0.7, "top_p": 0.9, "gpu_layers": 16, "max_tokens": 1024,
            "cpu_thread_pool_size": 6, "evaluation_batch_size": 1024,
            "rope_freq_base": 10000, "rope_freq_scale": 1.0,
            "offload_kv_cache_to_gpu": True, "keep_model_in_memory": True, "try_mmap": True,
            "seed": "auto", "flash_attention": True,
...
# Save customized JSON bundle
output_path_custom = "/mnt/data/lm_studio_model_bundle_custom.json"
with open(output_path_custom, "w") as f:
    json.dump(models_customized, f, indent=2)
